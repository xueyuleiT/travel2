...
public class NoBounsBehavior extends AppBarLayout.Behavior {
    ...
    public NoBounsBehavior() {
    }

    public NoBounsBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, AppBarLayout child, MotionEvent ev) {
        ...
        if (ev.getAction() == MotionEvent.ACTION_DOWN){
            ...
            try {
                Field field = getScrollerField();
                if (field != null){
                    field.setAccessible(true);
                    Object scroller = field.get(this);
    ...
    private boolean hasFlingRunnable = true;
    ...
    private Field getFlingRunnableField() throws NoSuchFieldException {
        ...
        try {
            ...
            } else if (headerBehaviorType != null && hasFlingRunnable) {
                return headerBehaviorType.getDeclaredField("mFlingRunnable");
            }else {
                return null;
            }
        } catch (NoSuchFieldException e) {
            hasFlingRunnable = false;
            e.printStackTrace();
            // 可能是28及以上版本
     ...
     * @param appBarLayout
     */
    public void stopAppbarLayoutFling(AppBarLayout appBarLayout) {
    ...
    private boolean hasScroller = true;
    ...
    private Field getScrollerField() throws NoSuchFieldException {
        ...
        try {
            ...
            }else if (headerBehaviorType != null && hasScroller) {
