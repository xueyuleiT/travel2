...
class ScenicBannerAdapter(data: List<ScenicDetailBean.ScenicPhotoListBean>, corners: Int): BannerAdapter<ScenicDetailBean.ScenicPhotoListBean, ScenicBannerAdapter.BannerViewHolder>(data) {
    ...
    override fun onBindView(
        ...
        data: ScenicDetailBean.ScenicPhotoListBean?,
        position: Int,
        size: Int
    ) {
