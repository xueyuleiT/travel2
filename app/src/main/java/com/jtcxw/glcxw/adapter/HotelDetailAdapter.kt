...
//
//class HotelDetailAdapter(context: Context, list: List<HotelDetailBean.HotelMsgListBean>):BaseRecyclerAdapter<HotelDetailBean.HotelMsgListBean>(context,list) {
...
//        view: View?,
//        model: HotelDetailBean.HotelMsgListBean?,
//        position: Int,
//        holder: CommonRecyclerViewHolder?
//    ) {
//    }
