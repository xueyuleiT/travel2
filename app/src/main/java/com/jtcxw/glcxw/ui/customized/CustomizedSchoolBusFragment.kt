...
class CustomizedSchoolBusFragment : BaseFragment<FragmentCustomizedBinding, CommonModel>() ,
    BusCustomizedView {

    companion object {
        fun newInstance(fragment: SupportFragment, bundle: Bundle?) {
            val customizedBusFragment = CustomizedSchoolBusFragment()
    ...
    override fun onGetCitysSucc(cityBean: CityBean) {
        ...
        if (!TextUtils.isEmpty(mCityId)) {
            ...
            jsonObject.addProperty("TripType", mTripType)
    ...
    override fun doAfterAnim() {
        ...
        mRootView!!.findViewById<TextView>(R.id.tv_center_title).setOnClickListener {
            ...
            DialogSelectorUtil.showCityPickView(context!!,provinceBeanList,cityList,cityListId,object :
                CityCallback {
        ...
        adapter.setOnItemClickListener(object : BaseRecyclerAdapter.OnItemClickListener<LineBean.RouteListBean>{
            override fun onItemClick(view: View?, model: LineBean.RouteListBean?, position: Int) {
                ...
                bundle.putInt(BundleKeys.KEY_TRIP_TYPE,12)
                ...
                BusLineGoOrderFragment.newInstance(this@CustomizedSchoolBusFragment.parentFragment as SupportFragment,bundle)
            }
